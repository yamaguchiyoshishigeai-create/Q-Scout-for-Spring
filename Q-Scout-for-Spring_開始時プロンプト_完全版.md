...
- `docs/10_企画/`  
  プロジェクトの背景、目的、提供価値、現在地を示す企画文書

- `docs/10_企画/15_将来構想/`  
  将来拡張方針・発展構想・訴求ポイントを示す構想文書

- `docs/20_要件定義/`  
  現行実装に関する正本・補助仕様・制約・読み順ガイド

- `docs/40_詳細設計/`  
  個別 UI / 差分設計 / 詳細仕様

- `docs/90_アーカイブ/`  
  履歴資料、旧フェーズ資料、現行正本ではない過去文書

重要:
- **将来構想は要件定義ではなく、企画の延長として扱う**
- **履歴資料は現行仕様判断の基準にしない**
- **現行要件判断は `20_要件定義ガイド.md` を起点に行う**
...
過去時点では `mvn test` 成功、102 件成功が確認されていますが、**新規チャットでは再確認を優先**してください。
