...
`scripts/run-sample-evaluation-under-samples.ps1` による公開サンプル評価は、Q-Scout の比較確認・誤検知確認・構造揺さぶり確認のための補助導線として運用します。
...
詳細な運用方針、採用理由、今後の追加方針は `docs/00_プロジェクト管理/05_横断運用規程/公開サンプル評価運用方針.md` を参照してください。
