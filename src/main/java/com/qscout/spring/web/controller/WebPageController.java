...
import com.qscout.spring.web.exception.LocalizedUserMessageException;
...
public class WebPageController {
    ...
    public String analyze(@RequestParam(value = "projectZip", required = false) MultipartFile file, Model model) {
        ...
        try {
            ...
            model.addAttribute("error", new ErrorViewModel(resolveUserMessage(exception), "INPUT_ERROR", true));
            ...
            model.addAttribute("error", new ErrorViewModel(resolveUserMessage(exception), "TIMEOUT", true));
    ...
    private String resolveUserMessage(RuntimeException exception) {
        if (exception instanceof LocalizedUserMessageException localized && localized.getMessageKey() != null) {
